  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/auth/register/student", {
        ...
        credentials: "include",
        body: JSON.stringify({ name, email, password, phoneNumber: phoneNumber || undefined }),
      });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 p-6">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            Sign up to discover events and opportunities matched to your interests
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <Link href="/auth/login?role=student" className="text-primary hover:underline">
              Sign in
            </Link>
          </div>
